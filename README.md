...
Enclosed you'll find Font Awesome version 5.2.x. In particular, the WOFF web font file as well as the CSS definitions. Font Awesome is by Dave Gandy &ndash; [http://fontawesome.com](http://fontawesome.com).
