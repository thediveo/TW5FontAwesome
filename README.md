...
Enclosed you'll find Font Awesome version 4.7.0. In particular, the WOFF web font file as well as the CSS definitions. Font Awesome is by Dave Gandy &ndash; [http://fontawesome.io](http://fontawesome.io).
